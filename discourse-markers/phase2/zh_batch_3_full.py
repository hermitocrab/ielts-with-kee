#!/usr/bin/env python3
"""Fill in all empty zh fields for batch_3.json - Complete version"""
import json
...
m['dm-689f447714']['example']['zh'] = 'A great example of this is how many young people now prefer to communicate online rather than in person.'
...
m['dm-0ca8e01db2']['example']['zh'] = 'Another good example is that many companies are now offering remote work options to attract talent.'

m['dm-4d5d2ede8d']['collocation']['zh'] = '使用模板：Exhibit A + [例1]; Exhibit B + [例2]; Exhibit C + [例3]'
m['dm-4d5d2ede8d']['contexts']['zh'] = '用于以列举形式给出多个例证，像法庭呈堂证据一样条理清晰'
m['dm-4d5d2ede8d']['connotation']['zh'] = '半正式'
m['dm-4d5d2ede8d']['example']['zh'] = 'Exhibit A, social media connects people globally; Exhibit B, it spreads information instantly.'

m['dm-ce16f719c6']['collocation']['zh'] = '使用模板：ranging from + [最小项] + to + [最大项]'
m['dm-ce16f719c6']['contexts']['zh'] = '用于列举一个范围内的多种事物，展示词汇丰富度'
m['dm-ce16f719c6']['connotation']['zh'] = '半正式'
m['dm-ce16f719c6']['example']['zh'] = 'The store sells a variety of products, ranging from fresh groceries to electronic devices.'

m['dm-6fc4db8789']['collocation']['zh'] = '使用模板：the most + [形容词] + example is that + [具体例证]'
m['dm-6fc4db8789']['contexts']['zh'] = '用于在论证中给出最具代表性的例子，强调其典型性'
m['dm-6fc4db8789']['connotation']['zh'] = '半正式'
m['dm-6fc4db8789']['example']['zh'] = 'The most striking example is that some countries have completely banned single-use plastics.'

m['dm-5f0e7a97c0']['collocation']['zh'] = '用于列举收尾：To name a few, + [列举几个例子]'
m['dm-5f0e7a97c0']['contexts']['zh'] = '在给出多个例证后用于收尾，表明这只是其中一部分例子'
m['dm-5f0e7a97c0']['connotation']['zh'] = '半正式'
m['dm-5f0e7a97c0']['example']['zh'] = 'Many cities are becoming more eco-friendly. To name a few, Copenhagen, Vancouver, and Singapore.'

# ===================== CAT-015: GENERALISATION =====================
...
m['dm-433172ed06']['example']['zh'] = 'There are a great variety of online courses available for students nowadays.'
...
m['dm-6cd703393b']['example']['zh'] = 'Students can choose from a wide range of extracurricular activities at university.'
...
m['dm-9f6ba5ad60']['example']['zh'] = 'I enjoy all kinds of dessert, especially those that are chocolate-based.'

m['dm-7b46615955']['collocation']['zh'] = '使用模板：In general, + [概括观点] + I am pretty sure I am not the only one who + [个人感受]'
m['dm-7b46615955']['contexts']['zh'] = '用于先做概括性陈述，再以共情口吻表达个人观点，拉近与听者距离'
m['dm-7b46615955']['connotation']['zh'] = '口语'
m['dm-7b46615955']['example']['zh'] = 'In general, I think people are becoming more health-conscious. I am pretty sure I am not the only one who tries to eat better these days.'

m['dm-be9ec5b394']['collocation']['zh'] = '置于句首或句中：plenty of + [名词]'
m['dm-be9ec5b394']['contexts']['zh'] = '用于表示数量充足、绰绰有余，比a lot of更口语化'
m['dm-be9ec5b394']['connotation']['zh'] = '口语'
m['dm-be9ec5b394']['example']['zh'] = 'There are plenty of opportunities for young people to gain work experience.'

m['dm-7df519c54e']['collocation']['zh'] = '置于句首：There are lots of + [名词复数]'
m['dm-7df519c54e']['contexts']['zh'] = '用于概括性地描述数量很多的事物，口语化程度较高'
...
m['dm-eb2e70d88b']['example']['zh'] = 'Apart from that, when it comes to education, I believe practical skills are just as important as academic knowledge.'

m['dm-93770a7dc0']['collocation']['zh'] = '使用模板：As far as + [话题] + goes, + [观点或观察]'
m['dm-93770a7dc0']['contexts']['zh'] = '用于将讨论范围限定在某一特定方面，展示话题管理能力'
m['dm-93770a7dc0']['connotation']['zh'] = '半正式'
m['dm-93770a7dc0']['example']['zh'] = 'As far as job satisfaction goes, I think work-life balance matters more than salary.'

m['dm-6a9c2ca318']['collocation']['zh'] = '使用模板：As far as + [话题] + is concerned, + [陈述]'
m['dm-6a9c2ca318']['contexts']['zh'] = '用于聚焦到某一具体话题进行讨论，比As far as...goes更正式'
m['dm-6a9c2ca318']['connotation']['zh'] = '正式'
m['dm-6a9c2ca318']['example']['zh'] = 'As far as environmental protection is concerned, individuals and governments share equal responsibility.'

m['dm-04c2a32eae']['collocation']['zh'] = '置于句首：As for + [话题], + [陈述]'
m['dm-04c2a32eae']['contexts']['zh'] = '用于转换话题或聚焦到某一特定方面，自然衔接'
...
m['dm-05ae977a7d']['example']['zh'] = 'As for students, we might feel pressured by the increasing competition in the job market.'
...
m['dm-6795992e23']['example']['zh'] = 'As for the reason why, it has a lot to do with changing social values and economic pressures.'
...
m['dm-2d4705cc1d']['example']['zh'] = 'As for the reason why, it is simply because most people prefer convenience over cost.'
...
m['dm-aef73ed66c']['example']['zh'] = 'As for the reasons, I would say technology has fundamentally changed the way we communicate with each other.'
...
m['dm-56aac0e3b6']['example']['zh'] = 'Regarding the impact of social media, I believe it has both positive and negative effects on society.'
...
# ===================== CAT-017: NARRATIVE / MEMORY =====================

m['dm-3ccf8dfa5e']['collocation']['zh'] = '使用模板：Thinking back to + [过去时间/群体] + , they used to + [过去的行为或习惯]'
m['dm-3ccf8dfa5e']['contexts']['zh'] = '用于Part 3中通过代际对比展现多角度分析能力'
m['dm-3ccf8dfa5e']['connotation']['zh'] = '半正式'
m['dm-3ccf8dfa5e']['example']['zh'] = 'Thinking back to my parents generation, they used to write letters instead of sending text messages.'

m['dm-b3e07238f1']['collocation']['zh'] = '置于句首引出回忆：As far as I can recollect, I + [过去动作]'
m['dm-b3e07238f1']['contexts']['zh'] = '用于在回忆往事时使用，比remember更正式'
m['dm-b3e07238f1']['connotation']['zh'] = '半正式'
m['dm-b3e07238f1']['example']['zh'] = 'As far as I can recollect, I first visited the museum when I was about ten years old.'

m['dm-e7ec4f0d10']['collocation']['zh'] = '置于句首引出回忆：As far as I can remember, + [过去的事件]'
m['dm-e7ec4f0d10']['contexts']['zh'] = '用于根据记忆描述过去的事件，自然叙事'
m['dm-e7ec4f0d10']['connotation']['zh'] = '半正式'
m['dm-e7ec4f0d10']['example']['zh'] = 'As far as I can remember, the town was much quieter and less crowded back then.'
...
m['dm-3156d01524']['example']['zh'] = 'As far as I can remember, when I was a little kid, I used to play in the park near my house every day after school.'

m['dm-a883ad5168']['collocation']['zh'] = '置于句首引出模糊记忆：I vaguely remember that + [不太清晰的事件]'
...
m['dm-3e9c5b4e0f']['example']['zh'] = 'I vaguely remember that, we used to go on family trips to the beach every summer when I was young.'

m['dm-159598e876']['collocation']['zh'] = '置于句首：If I recall correctly, + [根据记忆的陈述]'
m['dm-159598e876']['contexts']['zh'] = '用于在不确定的情况下表达自己的记忆，体现语言的严谨性'
m['dm-159598e876']['connotation']['zh'] = '半正式'
m['dm-159598e876']['example']['zh'] = 'If I recall correctly, the festival falls on the first weekend of October every year.'

m['dm-8a5c9d5140']['collocation']['zh'] = '置于句首：If I remember correctly, + [根据记忆的陈述]'
m['dm-8a5c9d5140']['contexts']['zh'] = '用于在不确定的情况下表达自己的记忆，较recall更口语化'
...
m['dm-da9a52abfe']['example']['zh'] = 'If my memory serves me right, we visited that museum during our school trip in Grade 6.'
...
m['dm-d4f5cde63c']['collocation']['zh'] = '使用模板：[陈述] + , in a manner of speaking（意为"从某种意义来说"）'
...
m['dm-7f7adb87c9']['example']['zh'] = 'She is, so to speak, a walking encyclopedia when it comes to history.'
...
m['dm-6eb065df05']['example']['zh'] = 'And bear in mind, most people have to work for decades before they can retire.'
...
m['dm-2cbbb3598a']['example']['zh'] = 'As I have mentioned, the key to success lies in consistent effort and dedication.'
...
m['dm-271fe2cbc9']['example']['zh'] = 'It is common sense that regular exercise is beneficial for both physical and mental health.'
...
m['dm-58d1d57016']['example']['zh'] = 'We all know that first impressions matter a lot in job interviews.'

# ===================== CAT-019: SPECIFICATION =====================

m['dm-c709672894']['collocation']['zh'] = '置于名词前表示强调：especially + [特别强调的部分]'
...
m['dm-2ef2852ad9']['collocation']['zh'] = '置于句首引出细节：Going into details, + [详细说明]'
